...
INSERT INTO user(email, password, name, nickname, phone, enabled, created_at) VALUES ('test2@naver.com', '$2a$10$OPGzvosDCDo4K7xPqieluejJ0osb.UheqlhRPHf.1qCm9gIYpI4cG', 'name', 'nickname', '01051969963', 1, now());
